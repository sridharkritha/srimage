...
unsigned char *LoadBitmapFile(char *filename, BITMAPInfo *bitmapInfoHeader)
{
    ...
    fread(bitmapInfoHeader, sizeof(BITMAPInfo),1,filePtr); // small edit. forgot to add the closing bracket at sizeof
...
bitmapData = LoadBitmapFile("img.bmp",&bitmapInfoHeader);
